...
export default function ContactsPageView({ content, emailAddress, socials }) {
        ...
        >
          ...
          {emailAddress ? (
            <div className="relative h-full">
              <SpotlightInfoCard
                title={content.cards.emailTitle}
              ...
              <div className="absolute top-3 right-3 z-20 flex items-center gap-1">
                ...
                {emailHref ? (
                  ...
                  >
                    <Link
                      href={emailHref}
                      aria-label={content.actions.openMailApp}
                      title={content.actions.openMailApp}
                    >
