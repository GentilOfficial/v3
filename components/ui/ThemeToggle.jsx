...
export function ThemeToggle({ onOpenChange, triggerAriaLabel, themeOptions }) {
  const { setTheme, theme } = useTheme()
  const [mounted, setMounted] = useState(false)
  const resolvedThemeOptions = themeOptions.map((option) => ({
    ...option,
  ...
  return (
    <DropdownMenu modal={false} onOpenChange={onOpenChange}>
      ...
      <DropdownMenuContent align="end">
        <DropdownMenuGroup>
          {resolvedThemeOptions.map(({ value, label, icon: ItemIcon }) => {
