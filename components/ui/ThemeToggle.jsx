...
function ThemeMenuItem({ value, icon: Icon, label, theme, animateThemeChange }) {
    return (
        <DropdownMenuItem
...
export function ThemeToggle() {
    ...
    const animateThemeChange = useCallback(async (newTheme) => {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button ref={buttonRef} variant="outline" size="icon" className="hover:cursor-pointer">
                    {renderIcon()}
                </Button>
            </DropdownMenuTrigger>
