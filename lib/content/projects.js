...
export function getProjectsFallbackResult(lang, issue) {
  return {
...
export async function getProjectsContent(lang, supabase) {
  if (!supabase) {
    return getProjectsFallbackResult(lang, "missing_env")
  }
  ...
  try {
    ...
    return getProjectsFallbackResult(lang, "db_unavailable")
  }
}
